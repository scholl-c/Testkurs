...
```{r}
Studis <- read.csv("https://assets.datacamp.com/production/repositories/3196/datasets/c729985d39110fcedf8ca170a763a31b0a59dd1f/Studierendenzaehlung.csv",sep=",",skip=1)
```
