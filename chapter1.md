...
```{r}
ex() %>% check_error() %>% check_or(
  check_operator(.,"*",not_called_msg="Hast du auch Operatoren verwendet?"),
  check_operator(.,"+",not_called_msg="Hast du auch Operatoren verwendet?"),
  check_operator(.,"-",not_called_msg="Hast du auch Operatoren verwendet?"),
  check_operator(.,"/",not_called_msg="Hast du auch Operatoren verwendet?")) %>% check_result() %>% check_equal()
